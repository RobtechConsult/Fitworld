...
## ForgeFit exercise figures — expansion 2026-08-21 (dumbbell bench press)

- **Assets:** `public/exercise-images/db-bench-press-0.png`, `public/exercise-images/db-bench-press-1.png`
- **Tool:** OpenAI built-in image generation (`gpt-image-2`), with native PNG alpha transparency and local 1024 × 1024 downscaling.
- **Date:** 2026-08-21
- **Source inputs:** None. Both assets were generated fresh; no prior exercise photos, images, or third-party inputs were used.
- **Prompt pattern:** `Matte technical anatomy plate depicting a non-human articulated training automaton. Its chassis consists only of muted-red muscle cables, pale tendons, and bone-like structural elements, with a blank oval cranial shell, resting on a compact plain horizontal support bench. Motion frame {A/B} of a two-hand dumbbell press. {keyframe description}. A faint #7c5cff technical accent is limited to pectoral cable bundles. Isolated transparent alpha canvas, no environment, floor, or shadow. Elegant printed engineering-and-medical illustration, soft diffuse light, matte surfaces, no glossy rendering, labels, or callouts. Full automaton centered, compact consistent zoom, gentle front-side three-quarter view. Constraints: explicitly artificial machine anatomy model; no person, skin, face, hair, text, logos, branding, or watermark. 1024 × 1024 PNG with alpha transparency.`
- **Prompt substitutions:** `A / elbow joints bent, forearm linkages upright, two dumbbell modules beside chest plate`; `B / forearm linkages upright, elbows almost open, two dumbbell modules above chest plate`.
- **Transparency processing:** Both final outputs were validated as 1024 × 1024 RGBA PNGs with transparent corners; imperceptible low-alpha background pixels were cleared during local alpha validation.

## ForgeFit exercise figures — expansion 2026-08-21 (incline bench press)

- **Assets:** `public/exercise-images/incline-bench-press-0.png`, `public/exercise-images/incline-bench-press-1.png`
- **Tool:** OpenAI built-in image generation (`gpt-image-2`), with native PNG alpha transparency and local 1024 × 1024 downscaling.
- **Date:** 2026-08-21
- **Source inputs:** None. Both assets were generated fresh; no prior exercise photos, images, or third-party inputs were used.
- **Prompt pattern:** `Matte technical anatomy plate depicting a non-human articulated training automaton, constructed only from muted-red muscle cables, pale tendons, and bone-like structural elements, with a blank oval cranial shell, resting against a compact neutral unbranded 45-degree exercise backrest. Motion frame {A/B} of an incline straight-bar press. {keyframe description}. A faint #7c5cff technical accent is limited to upper pectoral cable bundles. Isolated transparent alpha canvas, no environment, floor, or shadow. Elegant printed engineering-and-medical illustration, soft diffuse light, matte surfaces, no glossy rendering, labels, or callouts. Full automaton centered, compact consistent zoom, gentle front-side three-quarter view. Constraints: explicitly artificial machine anatomy model; no person, skin, face, hair, text, logos, branding, or watermark. 1024 × 1024 PNG with alpha transparency.`
- **Prompt substitutions:** `A / bar immediately above upper chest, elbow joints clearly bent at approximately 90 degrees, upper-arm links diagonally out, forearm links vertical`; `B / elbow joints nearly open, forearm links upright, bar over upper chest`.
- **Transparency processing:** Both final outputs were validated as 1024 × 1024 RGBA PNGs with transparent corners; imperceptible low-alpha background pixels were cleared during local alpha validation.
